...
describe('header', () => {
  ...
  describe('login/logout component', () => {
    ...
    it('should render the covid19 global warning with reduce visits to gp practices if feature flag set AND showDfocvc flag is false', componentTester(setup, (harness) => {
      const context = {
        config: {
          showCovid19: 'true',
          showDfocvc: 'false',
