...
export class Router {
  ...
  routes() {
    ...
    this.router.get('/solutions', (req, res) => {
    ...
    this.router.post('/solutions/capabilities-selector', withCatch(async (req, res) => {
    ...
    this.router.get('/solutions/:filterType.:capabilities?', withCatch(async (req, res) => {
    ...
    this.router.get('/solutions/:filterType.:capabilities?/:solutionId', withCatch(async (req, res) => {
    ...
    this.router.get('/solutions/:filterType.:capabilities?/:solutionId/document/:documentName', async (req, res) => {
