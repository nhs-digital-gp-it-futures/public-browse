...
test('Client application type - browser-based section should be rendered', async (t) => {
  ...
  await t
    ...
    .expect(supportedBrowsersRow.find('h4[data-test-id="view-section-table-row-title"]').visible).notOk()
...
test('Client application type - native-mobile section should be rendered', async (t) => {
  ...
  await t
    ...
    .expect(operatingSystemRow.find('h4[data-test-id="view-section-table-row-title"]').visible).notOk()
    .click(nativeMobileExpandableSection.find('summary'))

    .expect(await extractInnerText(operatingSystemRow.find('h4'))).eql('Supported operating systems')
    ...
    .expect(await extractInnerText(operatingSystemDescriptionRow.find('h4'))).eql('Description of supported operating systems')
    ...
    .expect(await extractInnerText(mobileFirstRow.find('h4'))).eql('Mobile first approach')
    .expect(await extractInnerText(mobileFirstRow.find('div[data-test-id="view-section-table-row-component"]'))).eql('Yes')
    .expect(mobileFirstRow.find('div[data-test-id="view-section-table-row-horizontal"]').exists).ok()

    .expect(await extractInnerText(minimumMemoryRow.find('h4'))).eql('Memory size')
    ...
    .expect(await extractInnerText(storageDescriptionRow.find('h4'))).eql('Storage space')
    ...
    .expect(await extractInnerText(minimumConnectionRow.find('h4'))).eql('Minimum connection speed')
    .expect(await extractInnerText(minimumConnectionRow.find('div[data-test-id="view-section-table-row-component"]'))).eql('1Mbps')
    .expect(minimumConnectionRow.find('div[data-test-id="view-section-table-row-horizontal"]').exists).ok()

    .expect(await extractInnerText(connectionRequirementsRow.find('h4'))).eql('Connection types supported')
    ...
    .expect(await extractInnerText(connectionDescriptionRow.find('h4'))).eql('Connection requirements')
    ...
    .expect(await extractInnerText(thirdPartyComponentsRow.find('h4'))).eql('Third-party components')
    ...
    .expect(await extractInnerText(deviceCapabilitiesRow.find('h4'))).eql('Device capabilities')
    ...
    .expect(await extractInnerText(hardwareRequirementsRow.find('h4'))).eql('Hardware requirements')
    ...
    .expect(await extractInnerText(additionalInformationRow.find('h4'))).eql('Additional information')
...
test('Client application type - native-desktop section should be rendered', async (t) => {
  ...
  await t
    ...
    .expect(await extractInnerText(operatingSystemDescriptionRow.find('h4'))).eql('Supported operating systems')
    ...
    .expect(await extractInnerText(minimumCPURow.find('h4'))).eql('Processing power')
    ...
    .expect(await extractInnerText(recommendedResolutionRow.find('h4'))).eql('Screen resolution and aspect ratio')
